...
$H_A:$at least one mean obp for a postion does not equal another mean obp
...
1 - pf(1.994,3,323) #prob that F(sub 3, 323) is greater than or = 1.994
```
...
<<<<<<< HEAD
#confidence interval (95%) for 1st base and 2nd base players 
=======
>>>>>>> 977f12315f34889940755c2dcdb66d690863e8a5
```
...
```{r}
(0.3224 - 0.3554) +c(-1, 1)*qt(1 - 0.05/(2*choose(7,2)), 320)*sqrt(0.001182)*sqrt(1/33 + 1/40)
#confidence interval (95%) for 3rd base and 1st base
```
